...
# cap.set(3, 1280)
# cap.set(4, 720)
cap = cv2.VideoCapture('11f95f57-pic20_jpg.rf.7ce680bdcf1c916cc644cc96b9028308.jpg')  # For Pic

model = YOLO("best.pt")

classNames = ['Bottle', 'Box', 'CAN', 'Can', 'Dustbin', 'LDPE', 'Tempat-sampah',
              'Trash-Can', 'bin', 'bottle', 'bottled-drinks', 'can', 'canned-drinks',
              'fake bag', 'glass', 'green bag', 'litter-bins', 'people',
